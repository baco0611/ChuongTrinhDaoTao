...
>>>>>>> manage_what
	...
	public EducationProgramEntity toEntity(UpdateEducationRequest request, EducationProgramEntity entity) {
		...
		FieldOfStudyEntity fieldOfStudyEntity = fieldOfStudyRepository.findByFieldCode(request.getFieldCode())
				.orElse(null);
		...
		entity.setProgramId(request.getProgramId()); // ensure this field is handled correctly if it's a read-only or
														// generated field
